"""
In this project, I organised a provided set of data regarding to the sales of a sewing supply shop.
"""
...
for i in range(0, len(colours)):
  print("Thread Shed sold " + str(colour_count(colours[i])) + " threads of " + colours[i] + " thread today.")
